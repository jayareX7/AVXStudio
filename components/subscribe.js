...
const Subscribe = () => {
    ...
    return (
      ...
      <div className="border border-gray-200 rounded p-6 my-4 w-full bg-gray-50">
        ...
        <form className="relative my-4" style={{marginTop: 2 + "rem"}} onSubmit={subscribeMe}>
            <input
            ...
            autoComplete="email"
            required
            className="py-4 px-0 text-md font-color-white bg-transparent w-9/12 text-gray-900 border-b-2 border-gray-600 dark:border-gray-400 dark:text-white focus:border-brand focus-visible:outline-none"
          />
          <button
